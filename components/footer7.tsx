...
const Footer7 = ({
  logo = {
    ...
    alt: "logo",
    title: "CounsellingApp",
  },
  sections = defaultSections,
  description = "Your safe space to talk, heal, and grow. Connect with licensed counsellors anytime, anywhere.",
  socialLinks = defaultSocialLinks,
  copyright = "© 2024 CounsellingApp. All rights reserved.",
